    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverAnchor asChild>
        <Textarea
          ...
          className="resize-none max-w-[98%] max-h-[150px] text-start pl-0 border border-transparent shadow-none focus:border focus:pl-2 focus:border-gray-200 focus:outline-none focus:ring-0 customVerticalScrollbar"
        />
      </PopoverAnchor>
