...
const TaskDetailDialog = ({
  ...
  const addFiles = (files: File[]) => {
    const attachments = files?.map((file: File) => ({
      fileName: file.name,
      fileUrl:
        "https://static.wikia.nocookie.net/darkestdungeon_gamepedia/images/6/6e/Darkest_Dungeon_cover_art.png/",
      fileType: file.type,
    }));
    handleUpdateTask.mutate({
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1 px-2 flex flex-col gap-2">
            ...
            <div className="border rounded-sm p-4 flex flex-col items-center gap-4">
              <img
                className="w-[100px] aspect-square object-cover object-center"
                src={
                  "https://res.cloudinary.com/djzdhtdpj/image/upload/v1768550438/download_xml15j.jpg"
                }
              />
              <span className="text-center text-sm max-w-[200px]">
                This is a filler cause i dont know what to put here, get JINXED
              </span>
            </div>
          </div>
        </div>
